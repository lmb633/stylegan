...
from model import StyleGenerator, StyleDiscriminator, gradient_penalty, R1Penalty, R2Penalty
...
def main(opts):
    ...
    if os.path.exists(opts.checkpoint):
        ...
        print("Pre-trained weight cannot load successfully, train from scratch!")
